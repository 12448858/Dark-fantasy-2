...
#Fondo del juego
fondo = pygame.image.load('imagenes/fondos/110106214-interfaz-de-juego-de-8-bits-plataformas-de-pixel-art-versión-móvil-y-de-escritorio-aparición-de.jpg')

#Música de fondo
pygame.mixer.music.load('sonido/WhatsApp Audio 2023-10-24 at 12.58.28 PM.mpeg')
...
while ejecuta:
    ...
    elif keys[pygame.K_d] and px < 1100 - velocidad - ancho:
        px += velocidad
        izquierda = False
        derecha = True
